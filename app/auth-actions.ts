 ...
 * Ab Phase 2 gehen Events und Raumpläne des Kontos dabei an den löschenden Admin über (wie
 * die Abstimmungen im Abstimmungstool) - Buchungen anderer Leute sollen nicht mit einem
 * Konto verschwinden.
 */
